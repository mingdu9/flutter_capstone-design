...
class _RankingState extends State<Ranking> {
  ...
  _getSize(){
    if(_myRankKey.currentContext != null){
      final RenderBox renderBox = _myRankKey.currentContext!.findRenderObject() as RenderBox;
    ...
    return Padding(
      ...
      child: Row(
          ...
          children: [
            Container(
              margin: EdgeInsets.only(right: 5),
              child: Text('${count+1}. ', style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 23,
                  letterSpacing: -1.2
              ),),
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      child: Text(stringList[imgList.indexOf(item)],
                        style: TextStyle(
                            fontSize: 25,
                            color: Colors.white,
                            letterSpacing: -1.1
